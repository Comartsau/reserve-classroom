...
const User = () => {
  ...
  return (
    <div className="h-screen bg-gray-300  p-2">
      ...
      <CardContent>
        <div className="flex flex-col gap-3 items-center justify-around align-middle px-6 py-4  rounded-md   bg-white">
          ...
          <div className=" w-full flex gap-2 mt-2 ">
            <div className="flex flex-col w-[50%] gap-3  align-middle  ">
              <Button
                variant="contained"
                className="w-full"
                onClick={handleReset}
            ...
            <div className="flex flex-col bg-black rounded-md py-2  w-[50%] gap-3 justify-around align-middle ">
              <div className="  p-2">
                ...
                <div className=" p-1">
                  <Typography className="text-white sx={{ fontSize: '10px' }} ">
